...
class Pembayaran extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $params = array('server_key' => 'SB-Mid-server-7wvcVUipiWo-aJw6GlanqFbx', 'production' => false);
    ...
    public function token()
    {
        ...
        $transaction_details = array(
            'order_id' => rand(),
            'gross_amount' => 800000, // no decimal allowed for creditcard
        );
